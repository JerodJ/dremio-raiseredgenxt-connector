...
@SourceType(value = "RaiserEdgeNXTARP", label = "RaiserEdgeNXT",uiConfig = "raiseredgenxt-layout.json")
public class RaiserEdgeNXTConf extends AbstractArpConf<RaiserEdgeNXTConf> {
  private static final String ARP_FILENAME = "arp/implementation/raiseredgenxt-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.raiseredgenxt.RaiserEdgeNXTDriver";
