...
3. Download and install the [Raisers Edge NXT JDBC Driver from CData](https://www.cdata.com/drivers/raisersedgenxt/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
